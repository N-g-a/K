...
function khoiTao() {
    ...
    list_products1 = getListProducts() || list_products1;
...
function themVaoGioHang(masp, tensp) {
    ...
    if (user.off) {
        ...
        addAlertBox('Tài khoản của bạn đã bị khóa .', '#FF66FF', '#fff', 10000);
        return;
    }
    var t = new Date();
    ...
    animateCartNumber();
    addAlertBox('Đã thêm ' + tensp + ' vào giỏ.', '#FF66FF', '#FFFF', 3500);
...
function signUp(form) {
    ...
    for (var ad of adminInfo) {
        if (newUser.username == ad.username) {
            alert('Tên đăng nhập đã có người sử dụng . Mời bạn kiểm tra lại');
            return false;
        }
    }
    ...
    <div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="tintuc.html"><i class="fa fa-newspaper-o"></i> Công nghệ 24h</a></li>
...
function addHeader() {
    ...
    <div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.png" alt="Hoài Linh Smartphone - iPhone " title="Hoài Linh Smartphone - iPhone ">
            </a>
        </div> <!-- End Logo -->
            ...
            <div class="search-header" style="position: relative; left: 162px; top: 1px;">
                <form class="input-search" method="get" action="index.html">
                    <div class="autocomplete">
                        <input id="search-box" name="search" autocomplete="off" type="text" placeholder="Nhập từ khóa... ">
                        <button type="submit">
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Hoài Linh Smartphone - iPhone</a>  & 
            <span style="color: #FFFFFF; font-size: 14px;">Sinh viên Trường đại học Khoa Học - Khoa CNTT - K44</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Giao hàng trong vòng 1 giờ</li>
                <li>Trải nghiệm sản phẩm tại nhà</li>
                <li>Lỗi đổi tại nhà trong 1 ngày</li>
                <li>Thanh toán linh hoạt: Tiền mặt,Trả góp ,Bank card </li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:12345678" style="color: #1E90FF;">0999880</a>
                </li>
            </ul>
        </section>
    </div>`);
...
function checkLocalStorage() {
    if (typeof(Storage) == "undefined") {
        alert('Máy tính không hỗ trợ lưu thông tin sản phẩm, khách hàng');
    } else {
