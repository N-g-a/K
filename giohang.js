...
window.onload = function() {
    ...
    var tags = ["Samsung", "iPhone", "Nokia", "Oppo", "Vivo", "Xiaomi"];
...
function addProductToTable(user) {
    ...
    for (var i = 0; i < user.products.length; i++) {
        ...
        var p = timKiemTheoMa(list_products1, masp);
...
function thanhToan() {
    ...
    if (window.confirm('Thanh toán giỏ hàng ?')) {
        ...
        capNhatMoiThu();
        addAlertBox('Các sản phẩm đã được gửi vào đơn hàng và chờ xử lý.', '#1E90FF', '#fff', 4000);
    }
}
