window.onload = function() {
    ...
    var company = ["Apple.jpg", "Samsung.jpg", "Oppo.jpg", "Nokia.jpg", "Vivo.jpg", "Xiaomi.jpg"];
    ...
    if (filters.length) { // có filter
        ...
        addKhungSanPham('ĐIỆN THOẠI NỔI BẬT', yellow_red, ['star=3', 'sort=rateCount-decrease'], soLuong, div);
        addKhungSanPham('SẢN PHẨM MỚI', blue, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong, div);
        addKhungSanPham('TRẢ GÓP ĐẾN 0%', yellow_red, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
        addKhungSanPham('KHUYẾN MÃI CHỈ CÓ TRÊN ONLINE', green, ['promo=giareonline', 'sort=rateCount-decrease'], soLuong, div);
        addKhungSanPham('KHUYẾT MÃI HOT', yellow_red, ['promo=giamgia'], soLuong, div);
    ...
    addPricesRange(8000000, 12000000);
    addPricesRange(12000000, 0);
